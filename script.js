...
const linkSvgIcons = {
  substack:
    '<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path fill="currentColor" d="M22.539 8.242H1.46V5.406h21.08v2.836zM1.46 10.812V24L12 18.375 22.54 24V10.812H1.46zM22.54 0H1.46v2.836h21.08V0z"/></svg>',
};

function appendLinkIcon(parent, item) {
  if (item.svg && linkSvgIcons[item.svg]) {
    const icon = document.createElement("span");
    icon.className = "link-button-icon";
    icon.innerHTML = linkSvgIcons[item.svg];
